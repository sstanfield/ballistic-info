//******** Tests With ideal Minimum Values of Unit values at G7 *********
// ******* Values based on ballistic calculator app *********
// ******* Didn't alter Weapon Bullet values ***************
// Status: Printing out NaN; haven't compared output yet
...
public class MinValuesTest {
	public final int MINRANGE = 1000, MINZERO = 0;
	...
	Weapon weapon = new Weapon(null,"M110","Semi Automatic",3112.0,3.755,true,7.0,MINZERO,atmo,bullet);//didn't change weapon
	Coriolis coriolis = new Coriolis(0.0,0.0,weapon.velocity);
	Ballistics ball = Ballistics.getBallistics(weapon, atmo, -89, 0, 0, MINRANGE, Ballistics.UNITS.IMPERIAL
			, 0, coriolis);
